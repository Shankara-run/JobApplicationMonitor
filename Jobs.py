...
class JobApplication:
    ...
    #job1= JobApplication(        company="TCS",         date_applied="2025-07-10",        job_role=job_role,         resume_version="Resume with Projects and Non Tech Data" ,        notes="Had interest in Cloud tech"        )
